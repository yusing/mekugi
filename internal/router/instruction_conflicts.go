...
func rewriteRequestInstructionConflicts(request *parsedResponsesRequest) error {
	...
	pairs := []string{
		...
		"Set report_now for immediate notices, or use the user-input tools for questions. Finish with a concise final answer; the router flushes it with the journal.",
