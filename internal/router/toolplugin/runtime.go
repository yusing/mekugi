...
//go:generate bun build ../../../plugins/tools.ts ../../../plugins/mrun.ts ../../../plugins/rtk.ts --outdir ./dist --splitting --production --target node --format esm --external mekugi:core/v1 "--banner=// Code generated by Bun from plugins sources. DO NOT EDIT."
