...
//go:generate bun build ../../../plugins/tools.ts ../../../plugins/mrun.ts --outdir ./dist --splitting --production --target node --format esm --external mekugi:core/v1 "--banner=// Code generated by Bun from plugins sources. DO NOT EDIT."
//go:embed host.mjs core-v1.mjs shared_core.wasm dist/*.js
var runtimeFiles embed.FS

const (
	pluginInvocationTimeout     = 5 * time.Second
...
func validateSnapshot(ctx context.Context, node, hostPath, pluginRoot string, modules []string) ([]Plugin, []string, error) {
	...
	err := invoke(ctx, node, hostPath, pluginRoot, "", nil, ExecutionOutputBudgetBytes, true, nil, nil, request, &response)
